(function() {
  ...
  function createModal() {
    ...
    overlay.innerHTML = `
      <div class="box">
        ...
        <div class="content">
          ...
          Вся информация перенесена на <b>новый</b> официальный сайт техникума.
        </div>
    ...
    // LOGO
    overlay.querySelector(".logoWrap").style = `
      display:flex;
      justify-content:center;
      margin-bottom:14px;
    `;
    ...
    // TITLE
    overlay.querySelector("h2").style = `
      margin:0 0 12px;
      font-size:22px;
      font-weight:700;
      color:#111;
    ...
    hover(goBtn, "0 14px 26px rgba(16,185,129,0.35)");
    hover(closeBtn, "0 14px 26px rgba(59,130,246,0.35)");
